...
Opcode::IaddImm => {
if rhs_3 == -1 {
if arg_3 != arg_1 && arg_3 != arg_2[0] && arg_1 == arg_2[0] {
let rep_insts = pos.func.dfg.inst_results(inst);
let rep_insts_0 = rep_insts[0];
...
Opcode::Band => {
if rhs_1 == -1 {
if arg_0[1] != arg_2[1] && arg_0[1] != arg_2[0] && arg_2[1] != arg_2[0] {
pos.func.dfg.replace(inst).band_not(arg_0[1], arg_1);
...
match opcode {
Opcode::Band => {
if arg_2[0] != arg_0[1] && arg_2[0] != arg_2[1] && arg_2[0] != arg_1[0] && arg_0[1] == arg_2[1] && arg_0[1] != arg_1[0] && arg_2[1] != arg_1[0] {
