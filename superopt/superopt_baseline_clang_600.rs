...
match opcode {
Opcode::Ishl => {
if arg_0[1] != arg_2[0] && arg_0[1] == arg_2[1] && arg_0[1] == arg_1[1] && arg_2[0] != arg_2[1] && arg_2[0] != arg_1[1] && arg_2[1] == arg_1[1] {
let rep_insts = pos.func.dfg.inst_results(inst);
let rep_insts_0 = rep_insts[0];
...
Opcode::IaddImm => {
if rhs_3 == -1 {
if arg_3 != arg_2[0] && arg_3 != arg_1 && arg_2[0] == arg_1 {
let rep_insts = pos.func.dfg.inst_results(inst);
let rep_insts_0 = rep_insts[0];
...
Opcode::SshrImm => {
if rhs_7 == 63 {
if arg_3 != arg_2 && arg_3 != arg_5 && arg_3 == arg_6 && arg_2 == arg_5 && arg_2 != arg_6 && arg_5 != arg_6 {
let rep_insts = pos.func.dfg.inst_results(inst);
let rep_insts_0 = rep_insts[0];
...
Opcode::Band => {
if rhs_1 == -1 {
if arg_2[0] != arg_0[0] && arg_2[0] != arg_2[1] && arg_0[0] != arg_2[1] {
pos.func.dfg.replace(inst).bor_not(arg_1, arg_1);
...
match opcode {
Opcode::Bxor => {
if arg_0[1] != arg_1[0] && arg_0[1] != arg_2[0] && arg_0[1] == arg_2[1] && arg_1[0] != arg_2[0] && arg_1[0] != arg_2[1] && arg_2[0] != arg_2[1] {
